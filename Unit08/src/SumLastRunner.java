...
public class SumLastRunner
{
	...
	{	
		...
		System.out.println(test.go(new int[] {9,10,-88,100,-555,2}));
		System.out.println(test.go(new int[] {10,10,10,11,456}));
		System.out.println(test.go(new int[] {-111,1,2,3,9,11,20,1}));
		System.out.println(test.go(new int[] {9,8,7,6,5,4,3,2,0,-2,6}));
		System.out.println(test.go(new int[] {12,15,18,21,23,1000}));
		System.out.println(test.go(new int[] {250,19,17,15,13,11,10,9,6,3,2,1,0}));
